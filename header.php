...
<div id="page" class="site">
		...
		<div class="site-branding">
			...
			<div class="site-branding__description">
				...
				<div class="site-branding__count">
					...
					elseif ( is_post_type_archive( 'cats' ) ) :
	...
	<?php
	// Additional class for static footer
	$footer_class = '';

	if ( is_home() || is_search() || ( is_archive() && ! is_post_type_archive() ) ) {
		$footer_class = ' margin__hidden';
	}
	?>
	<div id="content" class="site-content<?php echo esc_attr( $footer_class ); ?>">
